	...
	void loadData()
	{
		try
		{
			...
			while((type=br.readLine()) != null)
			{
				...
				{
					ac=new SavingsAccount(br.readLine(),br.readLine(),Double.parseDouble(br.readLine()),new Customer(br.readLine(), df.parse(br.readLine()), br.readLine(), br.readLine(), br.readLine(),br.readLine() ),br.readLine());
					ac.isActivated=Boolean.getBoolean(br.readLine());
				}
                                else if (type.equals(String.valueOf(Account.LOAN_ACCOUNT)))
				{
					ac=new LoanAccount(br.readLine(),br.readLine(),Double.parseDouble(br.readLine()),new Customer(br.readLine(), df.parse(br.readLine()), br.readLine(), br.readLine(), br.readLine(),br.readLine() ),br.readLine());
					ac.isActivated=Boolean.getBoolean(br.readLine());
				}
                                else if (type.equals(String.valueOf(Account.CURRENT_ACCOUNT)))
				{
					ac=new CurrentAccount(br.readLine(),br.readLine(),Double.parseDouble(br.readLine()),new Customer(br.readLine(), df.parse(br.readLine()), br.readLine(), br.readLine(), br.readLine(),br.readLine() ),br.readLine());
					ac.isActivated=Boolean.getBoolean(br.readLine());
				}
				addNewAccount(ac);
			}
